...
<html xmlns="http://www.w3.org/1999/xhtml">
  {layout:head("Preface: Catalogue of Carl Nielsen&apos;s Works (CNW)",(<link rel="stylesheet" type="text/css" href="/editor/style/mei_to_html_public.css"/>))}
  <body class="text">
    <div id="all">
      ...
      <div id="main">
      <h1>Preface</h1>
<p>The Catalogue of Carl Nielsen&apos;s Works (CNW) is the first ever thematic-bibliographic registration of all
...
<p>The Danish Centre for Music Publication collaborates with <i><a href="http://carlnielsen.org" 
title="Carl Nielsen 2015">Carl Nielsen 2015</a></i>.</p>
<div><br clear="all"/>
