...
let $html := doc("about.html")


let $contents :=
<html xmlns="http://www.w3.org/1999/xhtml">
  {layout:head("About the Catalogue of Carl Nielsen&apos;s Works (CNW)",(<link rel="stylesheet" type="text/css" href="/storage/style/mei_to_html_public.css"/>))}
  <body class="text">
    <div id="all">
