...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div>
            
		    {
            	    ...
            	    for $c in collection($database)/m:mei/m:meiHead/m:workList/m:work[m:title[@type='alternative']]
                    order by $c/m:title[@type='alternative'][1]/string()
            	    return
            	       <div>
            	       {
            	           (: first line (title) :)
