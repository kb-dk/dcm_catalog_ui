...
declare variable $css    := request:get-parameter("css","style/mei_to_html_print.css") cast as xs:string;
declare variable $style  := "style/transforms/mei_to_html_print.xsl";
